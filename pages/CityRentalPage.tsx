...
import { Heart, LogOut, Menu, X, Search, FileText, Building, HelpCircle, TrendingUp, MapPin, ArrowRight, DollarSign, Home, ChevronDown, Star, MessageSquare, Users, Shield } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-12 mb-12 md:mb-16">
              <div className="lg:col-span-1">
                ...
                <p className="text-sm text-neutral-500 mb-8 leading-relaxed">UnitPulse helps landlords and property managers streamline leasing with AI. From listing optimization to tenant engagement and application workflows, we turn rental operations into a faster, smarter experience.</p>
              </div>
