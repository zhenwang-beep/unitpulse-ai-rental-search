...
const PropertyDetailsModal: React.FC<PropertyDetailsModalProps> = ({
  ...
  const content = (
    <div className={`relative w-full ${isInline ? 'h-full bg-surface-app' : 'max-w-2xl max-h-[92vh] rounded-3xl shadow-2xl bg-white'} overflow-hidden flex flex-col`}>
            ...
            return (
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <h3 className="text-xs font-black text-black uppercase tracking-wider">Floor Plans</h3>
                  <span className="text-xs font-bold text-brand uppercase tracking-wider bg-surface-ai px-2.5 py-1 rounded-full">
      ...
      <div className="shrink-0 border-t border-black/5 bg-surface-app px-4 lg:px-6 py-3 lg:py-5">
