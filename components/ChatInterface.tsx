  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-2 flex-1">
        ...
        <div className="flex items-center gap-2 text-[10px] font-black text-black uppercase tracking-wider">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <button
            ...
            className="flex-1 py-1.5 bg-[#4A5D23] text-white rounded-lg text-xs font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-1.5"
          >
            <Calendar size={10} />
            Tour
          </button>
