    ...
    <div className="w-full h-full relative overflow-hidden flex flex-col p-6 bg-black">
       ...
       <div className="space-y-4 flex-1">
          ...
          <div className={`flex items-start gap-3 flex-row-reverse transition-all duration-700 delay-700 ${isActive ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4'}`}>
             ...
             <div className="bg-brand-on-dark/20 border border-brand-on-dark/20 rounded-2xl rounded-tr-none p-3 text-xs text-surface-ai shadow-sm">
        ...
        <div className="w-full h-full relative overflow-hidden flex flex-col items-center justify-center bg-black">
             <div className={`relative w-40 h-56 bg-neutral-900 rounded-xl border border-neutral-900 shadow-2xl overflow-hidden transition-all duration-700 ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                 ...
                 <div className={`absolute inset-0 bg-brand-on-dark/90 flex flex-col items-center justify-center gap-2 transition-all duration-300 delay-[1500ms] ${isActive ? 'opacity-100' : 'opacity-0'}`}>
                     ...
                     <span className="text-[10px] font-bold text-surface-ai uppercase tracking-widest">Verified</span>
                 </div>
             </div>
    ...
    return (
        <div className="w-full h-full relative overflow-hidden flex flex-col bg-black">
            ...
            <div className="p-6 pb-2 flex justify-between items-start z-10 relative">
                ...
                <div className={`px-2 py-1 bg-surface-ai border border-brand-on-dark/20 rounded text-[9px] text-brand-on-dark font-bold uppercase tracking-wider flex items-center gap-1 transition-opacity duration-1000 delay-500 ${isActive ? 'opacity-100' : 'opacity-0'}`}>
