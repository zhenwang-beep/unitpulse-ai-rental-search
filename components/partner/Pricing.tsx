      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <FadeIn delay={200} className="h-full">
            <div className="h-full p-8 rounded-2xl border-2 border-brand/25 bg-surface-ai flex flex-col transition-all hover:border-brand/40 hover:shadow-2xl hover:shadow-brand/15 shadow-xl shadow-brand/10 relative group transform md:-translate-y-6 overflow-hidden ring-1 ring-brand/10">
          ...
          <div className="max-w-6xl mx-auto mt-16 rounded-3xl overflow-hidden relative group shadow-2xl">
            ...
            <div className="relative z-10 p-10 md:p-16 flex flex-col items-center justify-center text-center">
              <div className="max-w-3xl flex flex-col items-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-ai border border-brand/20 mb-6">
